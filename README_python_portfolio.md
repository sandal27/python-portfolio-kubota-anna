...
![screenshot](3_one_click_launcher/images/screenshot_1.png) -- 仕事用モード
![screenshot](3_one_click_launcher/images/screenshot.png)   -- プライベート用モード
---
...
使用ライブラリ: flask
フォルダ: 6_big_text_app/
![screenshot](6_big_text_app/images/screenshot_1.png) -- 入力画面
![screenshot](6_big_text_app/images/screenshot_2.png) -- 通常モード、高コントラストモード
...
![screenshot](7_yes_no_button/images/screenshot_1.png) -- 通常モード
![screenshot](7_yes_no_button/images/screenshot_2.png) -- フルスクリーンモード
...
このポートフォリオに掲載しているプログラムは、すべて AI（ChatGPT）と一緒に作成したもの です。
